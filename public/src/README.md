...
the header and footer. It declares with `ngApp` that this is `Table-Reservation-App`,
...
"Table-Reservation-App" will rename the resultant CSS and JavaScript placed in `build/`,
